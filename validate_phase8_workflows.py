...
class FakeChain:
    ...
    def ask(self, question: str, category: str | None = None, state: str | None = None) -> dict[str, Any]:
        return {
            "question": question,
            "normalized_question": question.lower(),
            "answer": f"Grounded RAG answer for: {question}",
            "sources": [
                {
...
def test_weather_missing_location_and_follow_up(client: TestClient) -> None:
    ...
    assert_true(second["live_data"]["location"] == "Delhi", "follow-up should fill Delhi as location")
...
def test_static_questions_use_rag_workflow(client: TestClient) -> None:
    questions = [
        ...
        "Forest Rights Act mein Gram Sabha ka role kya hai?",
    ]
